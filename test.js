...
const wallet1 = Wallet["default"].fromPrivateKey(
  extendedKey.deriveChild(0).privateKey
);
const wallet2 = Wallet["default"].fromPrivateKey(
  extendedKey.deriveChild(1).privateKey
);
